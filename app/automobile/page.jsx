...
import AutomobileNavBar from "../AutomobileNavBar";
import AutomobileAboutUs from "../AutomobileAboutUs";
import AutomobileFooter from "../AutomobileFooter";
  ...
  return (
    <div
      style={{
        ...
        position: "relative",
        overflow: "hidden",
        background: "#F5E9D6", // fallback background - Cards/Dividers
      }}
    >
      ...
      <style jsx>{`
        ...
        .blob1 {
          ...
          left: -12vw;
          top: -10vw;
          background: #7A9B76; /* Buttons / Accents */
          animation-delay: 0s;
        }
        .blob2 {
          width: 30vw;
          ...
          right: -10vw;
          top: 10vw;
          background: #D2691E; /* Highlights / CTAs */
          animation-delay: 4s;
        }
        .blob3 {
          width: 28vw;
          ...
          left: 10vw;
          bottom: -8vw;
          background: #F5E9D6; /* Cards / Dividers */
          opacity: 0.35;
          animation-delay: 8s;
        }
        .blob4 {
        ...
        .image-card {
          ...
          overflow: hidden;
          box-shadow: 0 8px 32px #32323222, 0 1.5px 0 #7A9B76;
          background: #F5E9D6;
          min-height: 380px;
          cursor: pointer;
        ...
        .image-card:hover {
          box-shadow: 0 18px 48px #D2691E44, 0 4px 0 #7A9B76;
        ...
        .image-card-title {
          ...
          background: linear-gradient(180deg, #7A9B76ee 70%, #ffffff00 100%);
          color: #323232;
          font-size: 1.45rem;
          font-weight: 700;
        ...
        .image-card-desc-wrap {
          ...
          bottom: 0;
          width: 100%;
          background: linear-gradient(0deg, #F5E9D6 80%, #ffffff00 100%);
        ...
        .image-card:hover .image-card-desc-wrap {
          background: linear-gradient(0deg, #D2691E55 80%, #ffffff00 100%);
        }
        .image-card-desc {
          color: #6E6E6E;
          font-size: 1.08rem;
        ...
        <div className="relative z-10 text-left mt-17 md:mt-20 px-4 container mx-auto max-w-6xl">
          <div className={`hero-content ${isLoaded ? "loaded" : ""}`}>
            ...
            <h2
              ...
              style={{
                color: "#D2691E", // Highlight/CTA
                fontFamily: "IBM Plex Serif, serif",
                opacity: 0,
              }}
            >
              Ruhunugroup Auto Mobile – Sri Lanka
            </h2>
            {/* Main Title */}
            <h1
            ...
            >
              ...
              <span className="text-glow">Better Service</span>
            </h1>
            {/* Description */}
            <p
            ...
            >
              Powered by Ruhunugroup — powers mobility in the South with trusted solutions in fuel, vehicle parts, repairs and servicing
            </p>
            {/* Buttons */}
            <div
            ...
            >
              ...
              >
                ...
                <span
                  ...
                  style={{ background: "#F5E9D6" }} // Cards / Dividers
                >
                  <FaArrowRight style={{ color: "#7A9B76", fontSize: "0.9rem" }} />
                </span>
              </a>
              <a
                href="/contact"
              ...
              >
                ...
                >
                  <FaArrowRight style={{ color: "#D2691E", fontSize: "0.9rem" }} />
                </span>
              </a>
            </div>
          </div>
 ...
 <section className="py-20 px-4 bg-gradient-to-br from-[#FFFBE6] to-[#F5E9D6]">
  <div className="container mx-auto max-w-6xl">
    ...
    >
      ...
      >
        Our Premium Automatve Services
      </h2>
      <p
        className="text-lg"
        style={{ color: "#D2691E", fontFamily: "Inter, sans-serif" }}
      >
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
      {[
        {
          title: "Ruhunu Auto Service",
          image: "/auto.JPG",
          link: "/automobile/ruhunu-auto-service"
        },
        {
          title: "Ruhunu Motors",
          image: "/auto.JPG",
          link: "/automobile/ruhunu-motors"
        },
         {
          title: "Ruhunu Lanka IOC Filling Station",
          image: "/auto.JPG",
          link: "/automobile/ioc-filling-station"
        },
        {
          title: "Ruhunu Auto Impex",
          image: "/auto.JPG",
          link: "/automobile/ruhunu-auto-impex"
        },
      ].map((service, idx) => (
        <a
          key={idx}
        ...
        >
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-[#FFFBE6ee] to-transparent p-8 text-center">
              <span className="text-2xl md:text-3xl font-bold text-[#D2691E] drop-shadow-lg tracking-wide" style={{ fontFamily: "IBM Plex Serif, serif" }}>
                {service.title}
              </span>
            </div>
          </div>
