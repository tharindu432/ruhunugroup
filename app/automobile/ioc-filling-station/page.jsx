    ...
    <div className="min-h-screen bg-[#f5ede4]">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          ...
          <button className="bg-[#7a9b8a] hover:bg-[#6b8a79] text-white px-8 py-3 rounded-full font-medium transition-all duration-300 transform hover:scale-105">
          <a href='/automobile' >
            Discover More
          </a>
          </button>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div>
                <p className="text-[#7a7a7a] uppercase tracking-wider text-sm mb-4">
                  About Ruhunu Lanka IOC Filling Station
                </p>
                <h2 className="text-4xl md:text-5xl font-light text-[#4a4a4a] leading-tight mb-8">
                  A conveniently located   <br />
                  fuel station<br />
                   that provides fuel
                </h2> 
              </div>
              
              <div className="space-y-6 text-[#7a7a7a] text-lg leading-relaxed">
                <p>
                    Our IOC Filling Station in Ambalantota plays a critical role in powering the region — not just for individual motorists, but for large-scale clients including the Hambantota Port.
                </p>
                
                <p>
As a partner of Lanka IOC, we provide reliable and efficient fuel services with consistent quality and customer care. Our station is built to handle high volumes while ensuring fast, courteous service every time.
      ...
      <section className="py-20 px-4 md:px-8 lg:px-16 bg-[#f0e8dd]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#7a7a7a] text-lg max-w-2xl mx-auto">
              Discover exceptional experiences and world-class amenities at Ruhunu Lanka IOC Filling Station.
            </p>
          </div>
