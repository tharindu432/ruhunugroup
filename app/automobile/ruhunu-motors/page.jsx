            ...
            <div className="space-y-8">
              <div>
                <p className="text-[#7a7a7a] uppercase tracking-wider text-sm mb-4">
                  About Ruhunu Ruhunu Motors
                </p>
                <h2 className="text-4xl md:text-5xl font-light text-[#4a4a4a] leading-tight mb-8">
                  An authorized dealer of  <br />
                 tractor and vehicle parts
              ...
              <div className="space-y-6 text-[#7a7a7a] text-lg leading-relaxed">
                <p>
                    Ruhunu Motors is the leading name for spare parts sales in the region. We specialize exclusively in selling high-quality tractor and vehicle parts, backed by years of trusted service. 
                </p>
                
                <p>
Our knowledgeable team is always ready to provide expert advice and guidance to ensure customers get exactly what they need — nothing more, nothing less.
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#7a7a7a] text-lg max-w-2xl mx-auto">
              Discover exceptional experiences and world-class amenities at Ruhunu Motors.
            </p>
          </div>
