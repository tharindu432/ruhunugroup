          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-[#7a7a7a] text-lg leading-relaxed">
                <p>
                    Ruhunu Auto Impex bridges the gap between global automotive markets and local needs. Specializing in the import and export of vehicles and auto parts, we focus on sourcing only the best for our clients.
                </p>
                
                <p>
Whether you're looking to buy a reconditioned vehicle, import a specific brand, or supply spare parts for resale, our expertise and integrity make us a trusted partner in the automotive trade.
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#7a7a7a] text-lg max-w-2xl mx-auto">
              Discover exceptional experiences and world-class amenities at Ruhunu Auto Impex.
            </p>
          </div>
