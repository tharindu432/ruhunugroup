          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-[#7a7a7a] text-lg leading-relaxed">
                <p>
                    Ruhunu Auto Service in Ambalantota is your one-stop destination for car care. We offer full-service car washes, detailing, and basic maintenance to keep your vehicle looking sharp and performing its best.
                </p>
                
                <p>
                    With a strong focus on customer satisfaction, we ensure every vehicle leaves our facility cleaner, shinier, and better maintained — because your vehicle deserves nothing less.
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#7a7a7a] text-lg max-w-2xl mx-auto">
              Discover exceptional experiences and world-class amenities at Ruhunu Auto Service.
            </p>
          </div>
