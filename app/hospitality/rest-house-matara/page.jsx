            ...
            <div className="space-y-8">
              <div>
                <p className="text-[#6b6b6b] uppercase tracking-wider text-sm mb-4">
                  About Rest House Matara
                </p>
                <h2 className="text-4xl md:text-5xl font-light text-[#4a4a4a] leading-tight mb-8">
                  A  beachfront retreat 
                  offering comfortable rooms, <br />
                  and authentic Sri Lankan cuisine
                </h2>
              </div>
              
              <div className="space-y-6 text-[#6b6b6b] text-lg leading-relaxed">
                <p>
                    Rest House Matara is a timeless icon nestled within the historic walls of Matara Fort. With roots tracing back to the colonial era, it combines nostalgic charm with modern comfort. 
                </p>
                
                <p>
Overlooking the Indian Ocean, the property features spacious rooms, serene gardens, and a restaurant serving traditional Sri Lankan cuisine. Its heritage value and central location make it a favorite among travelers looking to explore the south while enjoying a peaceful and culturally rich stay.
                </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#6b6b6b] text-lg max-w-2xl mx-auto">
              Discover exceptional experiences and world-class amenities at Rest House Matara.
            </p>
          </div>
