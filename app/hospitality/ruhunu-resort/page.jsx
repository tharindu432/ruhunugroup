          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-[#6b6b6b] text-lg leading-relaxed">
                <p>
                 Ruhunu Resort is more than just a restaurant — it's a legacy. Widely recognized as the most prestigious dining destination in the region, we take pride in being trailblazers in the region’s hospitality scene.
                </p>
                
                <p>
                  Our menu showcases a range of Sri Lankan and international favorites, prepared with better excellence than you'd find elsewhere in the country. We’re honored to serve a community that values our high standards, and our BBQ station and pub add to the experience, making it the go-to spot for families, travelers, and corporate guests alike.
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#6b6b6b] text-lg max-w-2xl mx-auto">
              Discover exceptional experiences and world-class amenities at Ruhunu Resort
            </p>
          </div>
