    ...
    <>
      <style jsx>{`
        :root {
          ...
          --header: #323232;
          --description: #666666;
          --button-accent: #B6D1A9;
          --card-divider: #FFFFFF;
          --highlight-cta: #C9A13C;
        }
        ...
        @keyframes glow {
          0%, 100% { box-shadow: 0 0 20px rgba(201, 161, 60, 0.3);}
          50% { box-shadow: 0 0 40px rgba(201, 161, 60, 0.6), 0 0 60px rgba(201, 161, 60, 0.3);}
        }
        @keyframes countUp {
        ...
        .image-container::before {
          ...
          background: linear-gradient(135deg, rgba(182, 209, 169, 0.1), rgba(201, 161, 60, 0.1));
          border-radius: 24px;
          opacity: 0;
        ...
        .gradient-border {
          background: linear-gradient(135deg, #B6D1A9, #C9A13C);
          padding: 4px;
          border-radius: 24px;
          position: relative;
          overflow: hidden;
        ...
        .text-glow {
          text-shadow: 0 0 30px rgba(201, 161, 60, 0.4);
        }
        .floating-element {
        ...
        .stat-card:hover {
          ...
          border-color: var(--highlight-cta);
          box-shadow: 0 20px 40px rgba(201, 161, 60, 0.2);
        }
        .stat-number {
          font-size: 2.5rem;
          font-weight: bold;
        ...
        .cta-button {
          ...
          box-shadow: 0 8px 32px rgba(201, 161, 60, 0.3);
        }
        .cta-button:hover {
          transform: translateY(-4px) scale(1.05);
          box-shadow: 0 12px 40px rgba(201, 161, 60, 0.4);
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div className="space-y-8">
              ...
              >
                <FaQuoteLeft className="inline-block mr-2" style={{ color: "var(--highlight-cta)" }} />
                <span>
